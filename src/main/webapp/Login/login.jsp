        ...
        <div class="cart-wrap">
            ...
            <div class="mini-cart" role="dialog" aria-label="Sản phẩm mới thêm">
                ...
                <div class="mini-cart-footer">
                    ...
                    <a class="mini-cart-view" href="${pageContext.request.contextPath}/Cart/cart.jsp">Xem Giỏ Hàng</a>
                </div>
            </div>
        </div>

        <a class="topbtn" href="#"><i class="fa-solid fa-phone"> </i>Hotline</a>
        <a class="topbtn" href="${pageContext.request.contextPath}/login"><i class="fa-solid fa-user"> </i>Đăng Nhập
        </a>
    </div>
</header>
...
<main class="container">
    ...
    <div class="login-box">
        ...
        <p>Bạn chưa có tài khoản? <a href="${pageContext.request.contextPath}/Login/register.jsp">Đăng ký</a></p>
